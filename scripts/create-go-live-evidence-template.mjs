...
export function createTemplates(outputDir) {
  ...
  const files = {
    ...
    "evidence-sha256-manifest.README.md": [
      ...
      "",
      "Run `npm run production:evidence-seal -- --evidence-dir <outside-git-path>` after all P0 evidence files are in place.",
    ...
    "data-quality-report.README.md": [
      ...
      "",
      "Run: DATABASE_URL=postgresql://... npm run production:data-quality-check -- --json --output <outside-git-path>/data-quality-report.json",
    ...
    "data-quality-check.README.md": [
      ...
      "",
      "Save the text output of `npm run production:data-quality-check` as data-quality-check.txt.",
    ...
    "business-acceptance-check.README.md": [
      ...
      "Run: npm run production:business-acceptance-check -- --acceptance <outside-git-path>/business-acceptance.md",
