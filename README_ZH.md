...
Company ERP 是一个部署在公司 NAS 内网的轻量 Web ERP，用于支撑公司日常运营流程。项目目标不是做公网 SaaS，也不是完整财务、薪资、OCR、移动端或复杂审批平台，而是先把基础资料、采购、库存、项目点、合同和试运行运维闭环打通。
...
- 默认只支持公司内网访问，不配置公网暴露、HTTPS、外部域名或第三方登录。
